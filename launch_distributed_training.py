...
s3_prefix = "2025_06"
region = "us-east-1"
image_uri = "613602870396.dkr.ecr.us-east-1.amazonaws.com/proyecto_2_distributed:latest"  # Cambia esto
...
estimator = Estimator(
    ...
    role=role,
    instance_count=1,
    instance_type="ml.m5.large", # "ml.p3.8xlarge",  # 4 GPUs (MULTI_GPU)
    max_run=6 * 3600,
